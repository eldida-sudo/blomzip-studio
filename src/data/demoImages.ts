...
export const initialImages: ImageItem[] = [
  {
    ...
    src: "/images/courtyard/garden-photo.jpg",
    ...
    importSource: "Manual public/images/courtyard import",
  },
  {
    id: 2,
    ...
    src: "/images/courtyard/courtyard-story.png",
  ...
  },
  {
    ...
    src: "/images/courtyard/creative-reference.png",
  ...
  {
    id: 4,
    title: "Bladklänning i grönska",
    collection: "Innergård",
    date: "September 2025",
    tags: ["blad", "grönska", "couture", "skog", "fantasi"],
    favorite: true,
    hero: false,
    notes:
      "Första riktiga courtyard-bilden som ligger i public/images/courtyard. Bra för att testa att bilder från mappen visas korrekt.",
    color: "linear-gradient(135deg, #2f4f2f, #b7c89a)",
    src: "/images/courtyard/00009-478969167.png",
    alt: "Figur i grön bladklänning omgiven av tät grönska.",
    storyRole: "Visar fantasyspåret och bildmaterialets visuella potential.",
    season: "Sensommar",
    location: "Courtyard / grönska",
    mood: "Sagolik, frodig, stilla",
    material: "Blad, blomknoppar, mossa, skog",
    light: "Mjukt filtrerat grönljus",
    composition: "Central figur inramad av bladmassor",
    importSource: "Manual public/images/courtyard import",
  },
];